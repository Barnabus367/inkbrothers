...
export default function CrewSection() {
  ...
  return (
    <section
      id="artists"
      ref={sectionRef}
      className="relative py-20 px-4 ink-black overflow-hidden section-flow z-20 -mt-8"
      style={{
            ...
            {crewMembers.map((member, index) => (
              <div
                ...
                style={{
                  ...
                  transform:
                    hoveredMember === member.id ? "scale(1.02)" : "scale(1)",
                }}
              ...
              >
                ...
                <div className="relative h-full bg-gradient-to-br from-gray-900 to-black rounded-xl overflow-hidden border border-gray-800 transition-all duration-300 ease-out group-hover:border-red-500/50 group-hover:translate-y-[-4px] group-hover:scale-[1.02] group-hover:shadow-[0_0_16px_rgba(255,0,0,0.4)]">
                  ...
                  <div className="p-6 relative">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="relative">
                        ...
                        {/* Quote decorations */}
                        <div className="absolute -top-2 -left-2 text-red-500/30 text-3xl font-serif">
                          "
                        </div>
                        <div className="absolute -bottom-4 -right-2 text-red-500/30 text-3xl font-serif transform rotate-180">
                          "
                        </div>
                      </div>
                  ...
                  {/* Glitch Effect */}
                  <div
                    className={`absolute inset-0 bg-red-500/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none ${
