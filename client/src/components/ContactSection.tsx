            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-ink-white font-semibold">InkBrothers Studio</p>
                    <p className="text-gray-400">Bahnhofstrasse 42, 8001 Zürich</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-ink-white font-semibold">+41 44 123 45 67</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-ink-white font-semibold">info@inkbrothers.ch</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-ink-white font-semibold">Öffnungszeiten</p>
